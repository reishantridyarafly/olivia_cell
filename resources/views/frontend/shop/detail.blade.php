                        ...
                        <div class="owl-carousel product-slider" data-item="4">
                            <div class="u-s-m-b-30">
                                <div class="product-o product-o--hover-on">
                                            ...
                                            <ul class="product-o__action-list">
                                                <li>
                                                    <a href="javascript:(0);" id="addCart" class="product-view"
                                                        ...
                                                        title="Tambah Keranjang"><i class="fas fa-plus-circle"></i></a>
                                    ...
                                    <span class="product-o__category product-view" data-id="{{ $product->id }}">

                                        <a
                                            href="shop-side-version-2.html">{{ $recommendedProduct->catalog->name }}</a></span>

                                    <span class="product-o__name product-view" data-id="{{ $product->id }}">
