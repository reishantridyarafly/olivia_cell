                                ...
                                <div class="u-s-m-b-30">
                                    ...
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-15">
                                            ...
                                            <input class="input-text input-text--primary-style" type="text" id="billing-fname" value="{{ auth()->user()->first_name }}" disabled>
                                        </div>
                                        <div class="u-s-m-b-15">

                                            <label class="gl-label" for="billing-lname">NAMA BELAKANG *</label>

                                            <input class="input-text input-text--primary-style" type="text" id="billing-lname" value="{{ auth()->user()->last_name }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input class="input-text input-text--primary-style" type="text" id="billing-email" value="{{ auth()->user()->email }}" disabled>
                                    </div>
                                    <!--====== End - E-MAIL ======-->
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input class="input-text input-text--primary-style" type="text" id="billing-phone" value="{{ auth()->user()->telephone }}" disabled>
                                    </div>
                                    <!--====== End - PHONE ======-->
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <select class="select-box select-box--primary-style" id="address" name="address">
                                            <option value="">Pilih Alamat</option>
                                            @forelse ($address as $row)
                                            <option value="{{ $row->id }}" {{ $row->default_address == 0 ? 'selected' : '' }}>
                                                {{ $row->detail_address }}
                                            </option>
                                            @empty
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input class="input-text input-text--primary-style" type="text" id="province" name="province" disabled>
                                    </div>
                                    <!--====== End - Town / City ======-->
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <input type="hidden" name="weight" id="weight" value="{{ $weight }}" disabled>
                                        <input class="input-text input-text--primary-style" type="text" id="city" name="city" disabled>
                                        <!--====== End - Select Box ======-->
                                    </div>
                                    <!--====== End - STATE/PROVINCE ======-->
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <select class="select-box select-box--primary-style" id="courier" name="courier">
                                    ...
                                    <div class="u-s-m-b-15">
                                        ...
                                        <select class="select-box select-box--primary-style" id="shipping_cost" name="shipping_cost">
                                            ...
                                            <div class="o-card">
                                                <div class="o-card__flex">
                                                    <div class="o-card__img-wrap">
                                                        ...
                                                        <img class="u-img-fluid" src="{{ asset('storage/uploads/products/' . $product->photos->first()->photo_name) }}" alt="">
                                                    </div>
                                                    <div class="o-card__info-wrap">

                                                        <span class="o-card__name">

                                                            <a href="{{ route('shop.detail', $product->slug) }}">{{ $product->name }}</a></span>

                                                        <input type="hidden" name="product_id" id="product_id" value="{{ $product->id }}">
                                                        <input type="hidden" name="qty" id="qty" value="{{ $qty }}">
                                                        <input type="hidden" name="unit_price" id="unit_price" value="{{ $product->after_price }}">
                                                        <span class="o-card__quantity">Quantity x
                                                            {{ $qty }}</span>

                                                        <span class="o-card__price">{{ 'Rp ' . number_format($product->after_price * $qty, 0, ',', '.') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="o-summary__box">
                                            ...
                                            <div class="ship-b">
                                                <div class="u-s-m-b-15">
                                                    <!--====== Select Box ======-->
                                                    <div class="col-12">
                                                        <input type="file" class="form-control" name="transfer_proof" id="transfer_proof" accept="image/*">
                                                    </div>
                                                    <small class="text-danger errorTransferProof" style="color: red"></small>
                                                    <!--====== End - Select Box ======-->
                                                </div>
                                            </div>
                                        </div>
