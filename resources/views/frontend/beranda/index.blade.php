                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img collection__img"
                                        src="{{ asset('frontend/assets') }}/images/collection/coll-1.jpg" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-7 col-md-7 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--1286-890">
                                    ...
                                    <img class="aspect__img collection__img"
                                        src="{{ asset('frontend/assets') }}/images/collection/coll-2.jpg" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-7 col-md-7 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--1286-890">
                                    ...
                                    <img class="aspect__img collection__img"
                                        src="{{ asset('frontend/assets') }}/images/collection/coll-3.jpg" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-5 col-md-5 u-s-m-b-30">
                            ...
                            <a class="collection" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img collection__img"
                                        src="{{ asset('frontend/assets') }}/images/collection/coll-4.jpg" alt="">
                                </div>
                            </a>
                        </div>
                    </div>
                                            ...
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product2.jpg"
                                                        alt=""></a>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product4.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product5.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product6.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product7.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product8.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product9.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                        ...
                                        <div class="product-o product-o--hover-on product-o--radius">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product10.jpg"
                                                        alt=""></a>
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                            ...
                            <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product11.jpg"
                                            alt=""></a>
                            ...
                            <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product12.jpg"
                                            alt=""></a>
                                    <div class="product-o__special-count-wrap">
                                        <div class="countdown countdown--style-special" data-countdown="2020/05/01">
                                        </div>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                            ...
                                            <img class="aspect__img"
                                                src="{{ asset('frontend/assets') }}/images/product/electronic/product13.jpg"
                                                alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                            ...
                                            <img class="aspect__img"
                                                src="{{ asset('frontend/assets') }}/images/product/electronic/product14.jpg"
                                                alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                            ...
                                            <img class="aspect__img"
                                                src="{{ asset('frontend/assets') }}/images/product/electronic/product15.jpg"
                                                alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                            ...
                                            <img class="aspect__img"
                                                src="{{ asset('frontend/assets') }}/images/product/electronic/product16.jpg"
                                                alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                                ...
                                <div class="product-o product-o--hover-on">
                                    <div class="product-o__wrap">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                            ...
                                            <img class="aspect__img"
                                                src="{{ asset('frontend/assets') }}/images/product/electronic/product17.jpg"
                                                alt=""></a>
                                        <div class="product-o__action-wrap">
                                            <ul class="product-o__action-list">
                                                <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product19.jpg"
                                            alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product20.jpg"
                                            alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product21.jpg"
                                            alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on u-h-100">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block"
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/product/electronic/product22.jpg"
                                            alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img"
                                        src="{{ asset('frontend/assets') }}/images/promo/promo-img-1.jpg"
                                        alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img"
                                        src="{{ asset('frontend/assets') }}/images/promo/promo-img-2.jpg"
                                        alt="">
                                </div>
                                <div class="promotion__content">
                                    <div class="promotion__text-wrap">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                            ...
                            <a class="promotion" href="shop-side-version-2.html">
                                <div class="aspect aspect--bg-grey aspect--square">
                                    ...
                                    <img class="aspect__img promotion__img"
                                        src="{{ asset('frontend/assets') }}/images/promo/promo-img-3.jpg"
                                        alt="">
                                </div>
                                <div class="promotion__content">
                                    <div class="promotion__text-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product23.jpg"
                                                        alt=""></a>
                                            </div>
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product24.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product25.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product26.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product27.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product28.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product29.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product30.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i
                                        ...
                                        <div class="product-l">
                                            <div class="product-l__img-wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link"
                                                    ...
                                                    <img class="aspect__img"
                                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product31.jpg"
                                                        alt=""></a>
                                            </div>
                                            <div class="product-l__info-wrap">
                                                <div class="product-l__rating gl-rating-style"><i
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block"
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/blog/post-2.jpg"
                                            alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block"
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/blog/post-12.jpg"
                                            alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                                <div class="bp-mini__content">
                            ...
                            <div class="bp-mini bp-mini--img u-h-100">
                                <div class="bp-mini__thumbnail">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block"
                                        ...
                                        <img class="aspect__img"
                                            src="{{ asset('frontend/assets') }}/images/blog/post-5.jpg"
                                            alt=""></a>
                                    <!--====== End - Image Code ======-->
                                </div>
                                <div class="bp-mini__content">
                        ...
                        <div class="owl-carousel" id="brand-slider" data-item="5">
                            <div class="brand-slide">
                                ...
                                <a href="shop-side-version-2.html">
                                    ...
                                    <img src="{{ asset('frontend/assets') }}/images/brand/b1.png" alt=""></a>
                            </div>
                            <div class="brand-slide">

                                <a href="shop-side-version-2.html">

                                    <img src="{{ asset('frontend/assets') }}/images/brand/b2.png" alt=""></a>
                            </div>
                            <div class="brand-slide">

                                <a href="shop-side-version-2.html">

                                    <img src="{{ asset('frontend/assets') }}/images/brand/b3.png" alt=""></a>
                            </div>
                            <div class="brand-slide">

                                <a href="shop-side-version-2.html">

                                    <img src="{{ asset('frontend/assets') }}/images/brand/b4.png" alt=""></a>
                            </div>
                            <div class="brand-slide">

                                <a href="shop-side-version-2.html">

                                    <img src="{{ asset('frontend/assets') }}/images/brand/b5.png" alt=""></a>
                            </div>
                            <div class="brand-slide">

                                <a href="shop-side-version-2.html">

                                    <img src="{{ asset('frontend/assets') }}/images/brand/b6.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--====== End - Brand Slider ======-->
                                    ...
                                    <div id="js-product-detail-modal">
                                        <div>
                                            ...
                                            <img class="u-img-fluid"
                                                src="{{ asset('frontend/assets') }}/images/product/product-d-1.jpg"
                                                alt="">
                                        </div>
                                        <div>

                                            <img class="u-img-fluid"
                                                src="{{ asset('frontend/assets') }}/images/product/product-d-2.jpg"
                                                alt="">
                                        </div>
                                        <div>

                                            <img class="u-img-fluid"
                                                src="{{ asset('frontend/assets') }}/images/product/product-d-3.jpg"
                                                alt="">
                                        </div>
                                        <div>

                                            <img class="u-img-fluid"
                                                src="{{ asset('frontend/assets') }}/images/product/product-d-4.jpg"
                                                alt="">
                                        </div>
                                        <div>

                                            <img class="u-img-fluid"
                                                src="{{ asset('frontend/assets') }}/images/product/product-d-5.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="success u-s-m-b-30">
                                ...
                                <div class="success__img-wrap">
                                    ...
                                    <img class="u-img-fluid"
                                        src="{{ asset('frontend/assets') }}/images/product/electronic/product1.jpg"
                                        alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="outer-footer__content">
                                ...
                                <form class="newsletter">
                                    ...
                                    <span class="newsletter__text">Subscribe to the mailing list to receive
                                        updates
                                        on
