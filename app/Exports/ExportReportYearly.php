...
class ExportReportYearly implements FromCollection, WithHeadings, WithMapping, WithColumnWidths, WithTitle, WithStyles, WithEvents, WithCustomStartCell
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'LAPORAN PENJUALAN TAHUNAN');
